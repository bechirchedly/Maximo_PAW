...
const LaborTable = (props) => {
    ...
    return (
        ...
        <DataTable className="p-rowgroup-header" value={props.dataTable} paginator rows={5} expandedRows={expandedRows} onRowToggle={onRowTable}
                    ...
                    <Column field="taskid" header="Record" />
                    <Column field="amcrewtype" header="Class" />
                    <Column field="craft" header="Create By" />
                    <Column field="skilllevel" header="Date" />
                    <Column field="vendor" header="Type" />
                    <Column field="quantity" header="Summary" />
                    <Column field="amcrew" header="Viewable?" />
                </DataTable>
