...
const CommunicationLog = (props) => {
    ...
    return (
        ...
        <DataTable className="p-rowgroup-header" value={props.dataTable} paginator rows={5} expandedRows={expandedRows} onRowToggle={onRowTable}
                    ...
                    <Column field="taskid" header="Originating application" />
                    <Column field="amcrewtype" header=" ID" />
                    <Column field="craft" header="Create By" />
                    <Column field="skilllevel" header="To" />
                    <Column field="vendor" header="Date" />
                    <Column field="quantity" header="Subject" />
                </DataTable>
